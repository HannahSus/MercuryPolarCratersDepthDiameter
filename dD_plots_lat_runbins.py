...
##
##
# Program: dD_plots_lat_runbins
# Author: Hannah C.M. Susorney
# Date Created: 2020-03-04
#
# Purpose: To compare depth/diameter measurements in overlapping latitude bins
# Used in study
...
total_lat_bins_mla = int(10/latitude_bin_size) #85-75 =10
...
for i in range(0,total_lat_bins_mla):
    index_lat_bin_mla = np.where((latitude_mla>(middle_bins_lat_mla[i]-latitude_bin_size)) & (latitude_mla<(middle_bins_lat_mla[i]+latitude_bin_size)))
    ...
    index_lat_bin_radar_bright_mla = np.where((latitude_radar_bright_mla>(middle_bins_lat_mla[i]-latitude_bin_size)) & (latitude_radar_bright_mla<(middle_bins_lat_mla[i]+latitude_bin_size)))
    ...
    index_lat_bin_not_radar_bright_mla = np.where((latitude_not_radar_bright_mla>(middle_bins_lat_mla[i]-latitude_bin_size)) & (latitude_not_radar_bright_mla<(middle_bins_lat_mla[i]+latitude_bin_size)))
    ...
    index_lat_bin_rub = np.where((latitude_rub>(middle_bins_lat_mla[i]-latitude_bin_size)) & (latitude_rub<(middle_bins_lat_mla[i]+latitude_bin_size)))
...
for i in range(0,total_lat_bins_nancy):
    index_lat_bin_nancy = np.where((latitude_nancy>(middle_bins_lat_mla[i]-latitude_bin_size)) & (latitude_nancy<(middle_bins_lat_mla[i]+latitude_bin_size)))
    ...
    index_lat_bin_radar_bright_nancy = np.where((latitude_radar_bright_nancy>(middle_bins_lat_mla[i]-latitude_bin_size)) & (latitude_radar_bright_nancy<(middle_bins_lat_mla[i]+latitude_bin_size)))
    ...
    index_lat_bin_not_radar_bright_nancy = np.where((latitude_not_radar_bright_nancy>(middle_bins_lat_mla[i]-latitude_bin_size)) & (latitude_not_radar_bright_nancy<(middle_bins_lat_mla[i]+latitude_bin_size)))
...
plt.tight_layout()
plt.savefig(export_location+'meandD_v_runbinned_latitude_mla.pdf',format='pdf')
plt.close('all')
...
fig = plt.figure()
ax = fig.add_subplot(111)
ax.plot(middle_bins_lat_mla,mean_dd_bin_radar_bright_mla,'ko',label='MLA Non-radar-bright craters')
ax.errorbar(middle_bins_lat_mla,mean_dd_bin_radar_bright_mla, yerr=std_dd_bin_radar_bright_mla,fmt='ko',capsize=5)
ax.plot(middle_bins_lat_mla,mean_dd_bin_not_radar_bright_mla,'b^',label='MLA Radar-bright craters')
ax.errorbar(middle_bins_lat_mla,mean_dd_bin_not_radar_bright_mla, yerr=std_dd_bin_not_radar_bright_mla,fmt='b^',capsize=5)
...
ax.text(76, 0.202, 'depth=0.2Diameter',size=12)
ax.xaxis.set_major_locator(FixedLocator(np.arange(75, 90, 2)))
ax.set_ylim(0.05,0.25)
ax.set_xlim(75,85)

plt.tight_layout()
plt.savefig(export_location+'meandD_v_runbinned_latitude_binned_radarbright_v_nonradarbright_mla.pdf',format='pdf')
plt.close('all')
...
ax.plot(middle_bins_lat_mla,median_dd_bin_not_radar_bright_mla,'b^',label='Radar-bright craters')
ax.errorbar(middle_bins_lat_mla,median_dd_bin_not_radar_bright_mla, yerr=std_dd_bin_not_radar_bright_mla,fmt='b^',capsize=5)
...
plt.tight_layout()
plt.savefig(export_location+'mediandD_v_runbinned_latitude_binned_radarbright_v_nonradarbright_mla.pdf',format='pdf')
plt.close('all')
...
plt.tight_layout()
plt.savefig(export_location+'countdD_v_runbinned_latitude_binned_radarbright_v_nonradarbright_mla.pdf',format='pdf')
plt.close('all')
...
plt.tight_layout()
plt.savefig(export_location+'meandD_v_runbinned_latitude_nancy.pdf',format='pdf')
plt.close('all')
...
ax.plot(middle_bins_lat_nancy,mean_dd_bin_not_radar_bright_nancy,'m^',label='Gridded Radar-bright craters',alpha=0.5)
ax.errorbar(middle_bins_lat_nancy,mean_dd_bin_not_radar_bright_nancy, yerr=std_dd_bin_not_radar_bright_nancy,fmt='m^',capsize=5,alpha=0.5)
ax.plot([0,90],[0.2,0.2],':ko')
...
plt.tight_layout()
plt.savefig(export_location+'meandD_v_runbinned_latitude_binned_radarbright_v_nonradarbright_nancy.pdf',format='pdf')
plt.close('all')
...
plt.tight_layout()
plt.savefig(export_location+'mediandD_v_runbinned_latitude_binned_radarbright_v_nonradarbright_nancy.pdf',format='pdf')
plt.close('all')
...
plt.tight_layout()
plt.savefig(export_location+'countdD_v_runbinned_latitude_binned_radarbright_v_nonradarbright_nancy.pdf',format='pdf')
plt.close('all')
...
plt.tight_layout()
plt.savefig(export_location+'meandD_v_runbinned_latitude_binned_radarbright_v_nonradarbright_mla_nancy.pdf',format='pdf')
plt.close('all')
...
plt.tight_layout()
plt.savefig(export_location+'meandD_v_runbinned_latitude_mla_nancy_rub.pdf',format='pdf')
plt.close('all')
...
plt.tight_layout()
plt.savefig(export_location+'medianD_v_runbinned_latitude_mla_nancy_rub.pdf',format='pdf')
plt.close('all')
